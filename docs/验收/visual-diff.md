...
- 当前像素基线文件共 30 张，Playwright 用例实例共 33 个；
- 基线位于 `tests/visual/__screenshots__/workbench-baseline.spec.ts-snapshots/`、`tests/visual/__screenshots__/workbench-pane.spec.ts-snapshots/` 和 `tests/visual/__screenshots__/sidebar-preview.spec.ts-snapshots/`；
...
- 减少动态、减少透明度组合；
- 长会话、附件、完整模型菜单、上下文详情、运行、权限等待、提问、计划确认、步骤、账户菜单和设置页面；
