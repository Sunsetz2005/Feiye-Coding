 ...
 * Original implementation for Sunsetz (Tauri + React).
 */
...
const TREE_WIDTH_KEY = "sunsetz.resourceTreeWidth";
...
export function ResourceViewer({
  ...
  const [openWithTarget, setOpenWithTarget] = useState(() => {
    try {
      return localStorage.getItem("sunsetz.openTarget") || "finder";
    } catch {
      return "finder";
    }
  });
          ...
          {absPath ? (
            <OpenLocationButton
              ...
              onTargetChange={(t) => {
                setOpenWithTarget(t);
                try {
                  localStorage.setItem("sunsetz.openTarget", t);
                } catch {
                  /* ignore */
                }
              }}
