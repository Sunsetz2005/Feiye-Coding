...
const en = {
  ...
  "setup.subtitle": "MIT · Unofficial desktop workbench for Sunsetz Runtime",
  "setup.step.runtime": "Runtime",
  "setup.step.account": "Account",
  "setup.step.ready": "Ready",
  "setup.detecting": "Checking Sunsetz Runtime…",
  ...
  "setup.account.oauthHint": "Sign in with your Sunsetz account",
  ...
  "ext.error.cliTitle": "Sunsetz Runtime CLI not found",
  "ext.error.cliBody":
...
const zh: Record<MessageKey, string> = {
  ...
  "setup.subtitle": "MIT · 非官方 · 本机 Sunsetz Runtime 桌面指挥台",
  "setup.step.runtime": "运行时",
  "setup.step.account": "账户",
  "setup.step.ready": "就绪",
  "setup.detecting": "正在检测 Sunsetz Runtime…",
  ...
  "setup.account.oauthHint": "使用 Sunsetz 账号登录",
  ...
  "ext.error.cliTitle": "未找到 Sunsetz Runtime CLI",
  "ext.error.cliBody":
